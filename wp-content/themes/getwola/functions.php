...
function getwola_setup()
{
   ...
   */
  load_theme_textdomain('getwola', get_template_directory() . '/languages');
  ...
  add_theme_support(
    'custom-background',
    apply_filters(
      'getwola_custom_background_args',
      array(
...
add_action('after_setup_theme', 'getwola_setup');
...
function set_assets()
{
  ...
  wp_enqueue_script('script-cookie', get_template_directory_uri() . '/assets/js/cookie-banner.js', array(), $version_string, true);
  wp_enqueue_script('script-menu', get_template_directory_uri() . '/assets/js/menu.js', array(), $version_string, true);
...
add_action('after_setup_theme', function () {
  register_nav_menu('header_menu', 'Меню шапка');
  register_nav_menu('footer_menu', 'Меню подвала 1');
  register_nav_menu('footer_menu_second', 'Меню подвала 2');
});
